...
import sec1_img from "./sec1_img.jpg";
import sec4_img from "./sec4.jpg";
...
export const specialityData = [
  {
    ...
    description:
      "Provides primary care and treats a wide range of common illnesses.",
  },
  {
    speciality: "Gynecologist",
    image: Gynecologist,
    description:
      "Specializes in women's reproductive health and pregnancy care.",
  },
  {
  ...
  },
  {
    ...
    image: Neurologist,
    description:
      "Treats disorders of the brain, spinal cord, and nervous system.",
  },
  {
    speciality: "Gastroenterologist",
    image: Gastroenterologist,
    description:
      "Focuses on digestive system issues including the stomach and intestines.",
  },
];
